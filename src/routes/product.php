...
\Tina4\Get::add("/catalog/products", function (\Tina4\Response $response){
 ...
 */
\Tina4\Crud::route ("/catalog/products", new Product(), function ($action, Product $product, $filter, \Tina4\Request $request) {
    switch ($action) {
       case "form":
       case "fetch":
            ...
            if ($action == "form") {
                ...
                $title = "Edit Product";
                $savePath =  TINA4_SUB_FOLDER . "/catalog/products/".$product->id;
                $content = \Tina4\renderTemplate("/catalog/products/form.twig", ["data" => $product]);
            }
